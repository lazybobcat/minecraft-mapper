...
class MojangAPI
{
     ...
     */
    public function getUuid($username, $time = 0)
    {
     ...
     */
    public function getProfile($username, $time = 0)
    {
     ...
     */
    public function minifyUuid($uuid)
    {
        if (is_string($uuid)) {
     ...
     */
    public function getSessionProfile($uuid)
    {
        if (static::isValidUuid($uuid)) {
     ...
     * @return array|bool  Array with profile and properties, FALSE on failure
     */
    public function getTextures($uuid)
    {
     ...
     */
    public function getSkinUrl($uuid)
    {
     ...
     */
    public function getPlayerHead($uuid, $size = 100)
    {
     ...
     */
    public function getSteveHead($size = 100)
    {
     ...
     */
    public function getAlexHead($size = 100)
    {
     ...
     */
    public function getPlayerHeadFromSkin($skin, $size = 100)
    {
        if (is_string($skin)) {
     ...
     */
    public function printImage($img, $cache = 86400)
    {
     ...
     */
    public function embedImage($img)
    {
     ...
     */
    public function query($address, $port = 25565, $timeout = 2)
    {
     ...
     * @return array|bool  Array with query result, FALSE if query failed
     */
    public function ping($address, $port = 25565, $timeout = 2)
    {
        // Check arguments and if functions exists
        if (!is_numeric($timeout) or $timeout < 0 or !function_exists('fsockopen')) {
            return false;
